        ...
        <div class="card">
          <div class="card-body mt-4">
            <div class="col-lg-12">
              ...
              <table class="table table-striped w-100 table-sm table-borderless" id="getjasaigd" style="font-size: 10px;">
                <thead>
                  <tr>
...
<script>
  ...
  $(document).ready(function() {
    var table = $('#getjasaigd').DataTable({
      "processing": true,
      "serverSide": true,
      ...
      "order": true,
      "ajax": {
        "url": "<?= base_url('jaspel/getjasaigd') ?>",
        "type": "GET",
        "data": function(d) {
  ...
  document.getElementById("copyButton").addEventListener("click", function() {
    ...
    var table = document.getElementById("getjasaigd");
