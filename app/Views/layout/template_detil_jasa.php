...
<body>
  ...
  <body bgcolor="white">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center back-header" style="height: 30px;">
      <div class="container-fluid d-flex justify-content-between">
        <!-- Logo atau Menu -->

        <a class="logo d-flex align-items-center">
          <!-- <img src="/assets/img/kunci2.png" alt="" style="height:35px;">
        <span class="d-none d-lg-block text-white"> <img src="/assets/img/rs.png" alt="" style="height: 22px;"></span> -->
          <div class="search-bar text-white">
            <!-- <span class="d-none d-lg-block text-white fs-6"> DETAIL BILLING </span> -->
            <!-- <span class="d-none d-lg-block text-white" style="font-size: smaller; letter-spacing: 0.1em;"></span>
          <span class="d-none d-lg-block text-white" style="font-size:10px;font-weight:normal;letter-spacing: 0.1em;"> </span> -->
          </div>
        </a>
        ...
        <div class="d-flex align-items-center">
          <span class="text-white fs-7 ps-3"> DETAIL BILLING </span>&nbsp;&nbsp;
