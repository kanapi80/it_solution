...
<body>
    <?php if (!empty($billing)) : ?>
        ...
        <table width="100%" style="font-size: 10px;padding: 1px;border:none;margin-top: 1px;">
            <?php
        ...
        <table width="98%" style="font-size: 9px;border-collapse: collapse;border: 0px solid black;padding: 1px">
            ...
            foreach ($ruanganGrouped as $ruangan => $rows) {
                ...
                echo '<tr><td colspan="5" style="font-weight: bold;border-bottom: 0px dashed black;">&nbsp;' .
