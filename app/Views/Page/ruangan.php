...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h6 class="fw-bold">DATA RUANGAN</h6>
    <nav>
      <ol class="breadcrumb">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body mt-4">
            <div class="col-lg-12">
              <div>
                <table class="table table-striped w-100 table-sm table-borderless" id="getruangan" style="font-size: 10px;">
                  <thead>
                    <tr>
                      ...
                      <th class="bg-success text-white text-start">JENIS RUANGAN</th>
                      <th class="bg-success text-white text-start">TANGGAL CREATED</th>
                      <th class="bg-success text-white text-start" width="10%">STATUS</th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
...
<script>
  $(document).ready(function() {
    $('#getruangan').DataTable({
      "processing": true,
      "serverSide": true,
      "ajax": {
        "url": "<?= base_url('page/getruangan') ?>",
        "type": "get",
