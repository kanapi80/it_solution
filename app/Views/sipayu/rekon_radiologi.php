    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Radiologi Central</li>
                        ...
                        <table class="table table-striped w-100 table-sm table-borderless" id="getjasarajal" style="font-size: 9px;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-success text-white text-start" width="8%">DOKTER</th>
                                    <th class="bg-success text-white text-start" width="8%">RADIOGRAFER</th>
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#getjasarajal').DataTable({
            ...
            "order": true,
            "ajax": {
                "url": "<?= base_url('sipayu/getjasaradiologi') ?>",
                "type": "GET",
                "data": function(d) {
