    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"> F a r m a s i</li>
                    ...
                    <div class="card-body mt-4">
                        <div class="col-lg-12">
                            <div class="row g-2 align-items-center mb-2">
                                ...
                                <div class="col-auto">
                                    <select name="asal" id="asal" class="form-control form-control-sm">
                        ...
                        <table class="table table-striped w-100 table-sm table-borderless" id="getjasarajal" style="font-size: 9px;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-success text-white text-center" width="7%">JASPEL</th>
                                    <th class="bg-success text-white text-start" width="8%">JASPEL RVU</th>
                                    <th class="bg-success text-white text-start" width="8%">JASA RS</th>
                                    <th class="bg-success text-white text-start" width="6%">APOTEKER</th>
                                </tr>
                            </thead>
                            <tbody>
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#getjasarajal').DataTable({
            ...
            "order": true,
            "ajax": {
                "url": "<?= base_url('sipayu/getjasafarmasi') ?>",
                "type": "GET",
                "data": function(d) {
            ...
            "footerCallback": function(row, data, start, end, display) {
                ...
                let totaljaspel = api.column(7).data().reduce((a, b) => intVal(a) + intVal(b), 0);
                ...
                $(api.column(7).footer()).html(new Intl.NumberFormat('id-ID', {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2
                }).format(totaljaspel));
