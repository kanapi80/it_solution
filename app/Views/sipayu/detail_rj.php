    ...
    <section class="section ">
        <div class="row g-0">
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card-header p-0 m-0" style="background-color:#e8f2d9;">
        ...
        <div class="row g-0">
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card-header p-0 m-0">
                    ...
                    <b class="text-dark ps-1" style="font-size:9px;"> POLIKLINIK</b>
                </div>
                <div class="card-body p-1 ps-0">
                    <table width="100%" cellspacing="1px" cellpadding="3px" style="font-size:9px;padding-right:2px;padding-left:2px;" id="myTable1">
                        <tr class="bg-success text-center text-white" style="font-weight:bold;">
                            ...
                            <td width="30%" rowspan="2" class="text-start">URAIAN</td>
                            <td width="20%" rowspan="2" class="text-start">POLIKLINIK</td>
                            ...
                            <td colspan="5" class="text-center">JASA PELAYANAN</td>
                            <td width="8%" rowspan="2">TOTAL</td>
                        </tr>
                        <tr class="bg-success text-center text-white" class="text-center" style="font-weight:bold;">
                            ...
                            <td width="10%" class="text-center">RM</td>
                        </tr>
                        <?php if (count($jasamedis) > 0) {
                            ...
                            foreach ($jasamedis as $row) :
                                ...
                                $sumTotal = [
                                    $row['PundiRemunRvu'] + $row['JasaMedisRvu'] + $row['JasaMedisTindakanRvu'] + $row['JasaAsistenRvu'] + $row['JasaAdmRvu'] + $row['jasaAsisten_kebersamaan'] + $row['jasaRM_rvu']
                                ];

                                $tarif = array_sum($sumTarif);
                                $pelayanan = array_sum($sumPelayanan);
                                $pelayananRvu = array_sum($sumJaspelrvu);
                                $rs = array_sum($sumRS);
                                ...
                                $totalPelayananRvu[] = $pelayananRvu;
                                $totalTarif[] = $tarif;
                                $totalRS[] = $rs;
                                $totalMedis[] = $medis;
                        ...
                        ?>
                                <tr bgcolor="#FFFFFF">
                                    ...
                                    <td width="10%" class="text-end"><?= number_format($row['JasaMedisRvu'] + $row['JasaMedisTindakanRvu'], 2, ",", ".") ?></td>
                                    <td width="10%" class="text-end"><?= number_format($row['JasaAsistenRvu'], 2, ",", ".") ?></td>
                                    <td width="10%" class="text-end"><?= number_format($row['JasaAdmRvu'] + $row['jasaAsisten_kebersamaan'], 2, ",", ".") ?></td>
                                    <td width="10%" class="text-end"><?= number_format($row['jasaRM_rvu'], 2, ",", ".") ?></td>
                                    <td width="10%" class="text-end"><?= number_format($row['PundiRemunRvu'] + $row['JasaMedisRvu'] + $row['JasaMedisTindakanRvu'] + $row['JasaAsistenRvu'] + $row['JasaAdmRvu'] + $row['jasaAsisten_kebersamaan'] + $row['jasaRM_rvu'], 2, ",", ".") ?></td>
                                </tr>
                            <?php endforeach; ?>
                            ...
                            <tr style="font-weight:bold" bgcolor="#e9ebee">
                                <td bgcolor="e9ebee" colspan="5" class="text-end" cellspacing="1px" cellpadding="3px" height="25px">
                                    Sub Total </td>
                                <td width="10%" class="text-end" cellspacing="1px" cellpadding="3px"><?= number_format(array_sum($totalTarif), 2, ",", ".") ?></td>
                                <td width="10%" class="text-end" cellspacing="1px" cellpadding="3px"><?= number_format(array_sum($totalPelayanan), 2, ",", ".") ?></td>
                                <td width="10%" class="text-end" cellspacing="1px" cellpadding="3px"><?= number_format(array_sum($totalPelayananRvu), 2, ",", ".") ?></td>
                                <td width="10%" class="text-end" cellspacing="1px" cellpadding="3px"><?= number_format(array_sum($totalRS), 2, ",", ".") ?></td>
                                <td width="10%" class="text-end" cellspacing="0px" cellpadding="0px"><?= number_format(array_sum($totalMedis), 2, ",", ".") ?></td>
                                <td width="10%" class="text-end" cellspacing="0px" cellpadding="0px"><?= number_format(array_sum($totalAsisten), 2, ",", ".") ?></td>
                                <td width="10%" class="text-end" cellspacing="0px" cellpadding="0px"><?= number_format(array_sum($totalKebersamaan), 2, ",", ".") ?></td>
                                <td width="10%" class="text-end" cellspacing="0px" cellpadding="0px"><?= number_format(array_sum($totalRM), 2, ",", ".") ?></td>
                                <td width="10%" class="text-end" cellspacing="0px" cellpadding="0px"><?= number_format(array_sum($totalJasa), 2, ",", ".") ?></td>
                            </tr>
                            ...
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="card-body p-1 ps-0">
                                    ...
                                    if (count($jasaoperasi) > 0) {
                                        ...
                                        $sumJasaOp = [
                                            array_sum($totalMedisOperatorOp) + array_sum($totalMedisAnastesiOp) + array_sum($totalPerawatOp) + array_sum($totalPenataOp) + array_sum($totalKebersamaanOp)
                                        ];
                                    ...
                                    ?>
                                    <table cellspacing="1px" cellpadding="3px" style="font-size:9px;padding-right:2px;padding-left:2px;" width="100%" id="myTable1">
                                        <tr style="font-weight:bold">
                                            <td height="25" bgcolor="#e9ebee" class="text-end" cellspacing="1px" cellpadding="3px">&nbsp;</td>
                                            <td width="18%" bgcolor="#e9ebee" class="text-end" cellspacing="1px" cellpadding="3px"> Total Jasa Pelayanan</td>
                                            <td width="10%" bgcolor="#e9ebee" class="text-end" style="font-weight: 600;" cellspacing="0px" cellpadding="0px"><?= number_format($JPJasa + $JPLab + $JPFar + $JPRad + $JPOp, 2, ",", "."); ?></td>
                                        </tr>
                                        <tr style="font-weight:bold">
                                            <td height="25" bgcolor="#e9ebee" class="text-end" cellspacing="1px" cellpadding="3px">&nbsp;</td>
                                            <td bgcolor="#e9ebee" class="text-end" cellspacing="1px" cellpadding="3px"> Total Jasa RS</td>
                                            <td width="10%" bgcolor="#e9ebee" class="text-end" style="font-weight: 600;" cellspacing="0px" cellpadding="0px"><?= number_format($RSJasa + $RSLab + $RSRad + $RSFar + $RSOp, 2, ",", "."); ?></td>
                                        </tr>
                                        <tr style="font-weight:bold">
                                            <td height="25" bgcolor="#e9ebee" class="text-end" cellspacing="1px" cellpadding="3px">&nbsp;</td>
                                            <td bgcolor="#e9ebee" class="text-end" cellspacing="1px" cellpadding="3px"> Total Jasa Pelaksana</td>
                                            <td width="10%" bgcolor="#e9ebee" class="text-end" style="font-weight: 600;" cellspacing="0px" cellpadding="0px"><?= number_format($JPel + $JPelLab + $JPelRad + $JPelFar + $JPelOp, 2, ",", "."); ?></td>
                                        </tr>
                                        <tr style="font-weight:bold">
                                            <td height="25" bgcolor="#e9ebee" class="text-end" cellspacing="1px" cellpadding="3px">&nbsp;</td>
                                            <td bgcolor="#e9ebee" class="text-end" cellspacing="1px" cellpadding="3px"> Total Pembagian Jasa</td>
                                            <td width="10%" bgcolor="#e9ebee" class="text-end" style="font-weight: 600;" cellspacing="0px" cellpadding="0px"><span class="badge bg-success" style="border-radius: 2px;font-size:10px"><?= number_format($jasa + $lab + $rad + $far + $op, 2, ",", "."); ?></span></td>
                                        </tr>
                                    </table>
