      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body fs-6 text">
            <div class="mb-3">
              <form action="<?= base_url('sipayu/cariranap') ?>" method="get">
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group mt-3">
                      <!-- <label for="inputIdRegisterKunjungan" class="form-label mt-3">IdRegisterKunjungan</label> -->
                      <input type="number" class="form-control form-control-sm" name="id" placeholder="IdRegisterKunjungan" value="<?= esc($id) ?>">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group mt-3">
                      <!-- <label for="inputNamaPasien" class="form-label mt-3">NamaPasien</label> -->
                      <input type="text" class="form-control form-control-sm" name="nama" placeholder="Nama Pasien" value="<?= esc($nama) ?>">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group mt-3">
